...
A lightweight, real-time **embedded web dashboard** for the [WarPi.G](https://github.com/rsftomb/warpig) Wardriving app, designed for Raspberry Pi (Zero 2W and up).
